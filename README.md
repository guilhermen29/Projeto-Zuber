...
* a distribuição das corridas entre empresas
* as regiões com maior demanda de transporte
* o possível impacto das condições climáticas na duração das viagens

Esses insights podem contribuir para análises de mobilidade urbana e tomada de decisão em empresas de transporte.
...
Projeto desenvolvido como parte do programa de **Analista de Dados da TripleTen**.
